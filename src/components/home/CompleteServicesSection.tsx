      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-gray-900 mb-6">My Process</h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-bold text-gray-900">Discovery</h4>
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-bold text-gray-900">Planning</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-bold text-gray-900">Delivery</h4>
              <p className="text-gray-600">
